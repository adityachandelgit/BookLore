...
class FileOperationsServiceTest {
    ...
    void testGeneratePathWithAllFieldsPresent() {
        ...
        String result = fileOperationsService.generatePathFromPattern(book, pattern);

        assertThat(result).isEqualTo("/Dune Saga/01 - Dune by Frank Herbert (1965).epub");
    }
    ...
    void testGeneratePathWithMissingMetadata() {
        ...
        String result = fileOperationsService.generatePathFromPattern(
                book,
                "/{title}_{authors}_{year}_{series}_{seriesIndex}_{language}_{publisher}_{isbn}"
        );
        assertThat(result).isEqualTo("/Untitled_Unknown Author______.pdf");
    }
    ...
    void testGeneratePathWithNoExtension() {
        ...
        String result = fileOperationsService.generatePathFromPattern(book, "/{title}");
    ...
    void testGeneratePathWithIsbn10Fallback() {
        ...
        String result = fileOperationsService.generatePathFromPattern(book, "/{isbn}");
    ...
    void testGeneratePathWithEmptyPattern() {
        ...
        String result = fileOperationsService.generatePathFromPattern(book, "");
    ...
    void testGeneratePathWithOptionalBlockIncluded() {
        ...
        assertThat(result).isEqualTo("Series/02. Book Title.pdf");
    }
    ...
    void testPatternWithMultipleOptionalBlocks() {
        ...
        assertThat(result).isEqualTo("Stack/03. English/Layered.epub");
    }
    ...
    void testEmptyOptionalBlockIsIgnored() {
        ...
        String result = fileOperationsService.generatePathFromPattern(book, "<>");
        assertThat(result).isEqualTo(".epub");
    }
